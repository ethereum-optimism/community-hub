...
In carrying out these functions, OP holders may either vote directly, or delegate their OP voting power to someone else. Learn about delegation [here[(https://community.optimism.io/token-house/how-to-delegate).
...
[Historical Governance Seasons](https://community.optimism.io/token-house/token-house-history)
