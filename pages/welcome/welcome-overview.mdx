...
The [Optimism Decentralization Milestone Working Model](https://docs.google.com/spreadsheets/d/1IpL0oTd3AgNBu_eWdjP9EjbQfZjq-_Nd3yU1H2ke3vY/edit?gid=0#gid=0) outlines general steps the Collective ecosystem can take on its journey towards ever-increasing levels of decentralization and governance minimization. It is **not** a roadmap, but rather a working model outlining the path the Foundation currently envisions. The actual path may deviate in response to dynamic conditions and execution that depends on contributions from a wide variety of contributors across the Collective. This model is meant to be directional, rather than prescriptive. 

### Decision Diagram Working Model

The [Optimism Decision Diagram Working Model](https://www.figma.com/board/iXqyKmLJeBeplKpJBHDI7G/PUBLIC%3A-Optimism-Decision-Diagram-Working-Model?node-id=0-1&node-type=canvas&t=QLiz1uM1DepwYyHy-0) is advisory in nature: it provides guidance to the community on how the Foundation considers various decision pathways across the Collective, and is intended to inform - but not define - the governance community’s decision-making processes. Working models are intended to preserve flexibility, and allow the community to collaborate in testing, adapting, and evolving them over time. 
