...
![OP Token Allocations](/img/op-token/op-token-allocation.jpg)
...
Airdrop 5 took place on the 9th of Oct 2024, and distributed **10,368,678 OP to 54,723 unique addresses.** Airdrop #5 rewarded power users who have contributed to the growth of the Superchain Ecosystem. The best apps across social, DeFi, gaming and more live on the Superchain, and it’s crucial to support their growth and success. EOA addresses that made App transactions on OP Mainnet, Base, Zora, Mode, Metal, Fraxtal, Cyber, Mint, Swan, Redstone, Lisk, Derive, BOB, Xterio, Polynomial, Race, and Orderly between 2024-03-15 00:00:00 UTC and 2024-09-15 00:00:00 UTC within the Airdrop #5 criteria recieved this airdrop.

See the [Airdrop #5 documentation](/op-token/airdrops/airdrop-5) for a detailed breakdown of eligibility criteria.
...
All tokens distributed as part of the Investors allocation will be subject to a lockup period.
...
64% of the initial token supply (i.e., the aggregate amount of OP **not** reserved for core contributors or Investors) will be distributed to the community as described above.
