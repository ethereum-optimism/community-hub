...
2. See full list of addresses and allocation amounts [here](#).
3. The OP tokens that would have gone to these addresses were reallocated proportionally to eligible addresses.
