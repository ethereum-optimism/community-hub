...
The goal has always been to expand the Citizens' House. In past Seasons, the Optimism Foundation ran several experiments to gain insights that would help pave the way for a more permanent expansion to the Citizens' House. These learnings are summarized [here](community.optimism.io/citizens-house/experimentation-with-citizenship).
...
Citizenship is about governance participation, not financial incentives. You should only register if you genuinely want to express your interests in the Superchain as a chain, app or Superchain end-user.
...
Voting power distribution among the various groups of voters varies by proposal type and can be looked up in the [Operating Manual](https://github.com/ethereum-optimism/OPerating-manual/blob/main/manual.md). Within the chain group, each chain has equal voting power (1 chain, 1 vote).
...
### How and why do I need to prove I'm a human?
...
To prove you are a unique human, you can either connect your World id, or link an address to your account that has a Human Passport score of at least 20. You can gather stamps and increase your Passport score at https://app.passport.xyz/
...
Voting power distribution among the various groups of voters varies by proposal type and can be looked up here. Within the end-users group, each user has equal voting power (1 user, 1 vote).
