...
To create an application to interact with your contract, follow the steps below:
...
2. Input your preferences for the command line prompts:
   ...
   2. Choose your network: We will choose EVM for Optimism
...
In this section, we will show you how to interact with your contract deployed to Optimism using React
