...
**Note:** The L1 Ethereum parameter values are taken from [ethereum.org](https://ethereum.org/en/developers/docs/blocks/#block-time). The OP Mainnet values are taken from [the OP Mainnet specs](https://github.com/ethereum-optimism/optimism/blob/65ec61dde94ffa93342728d324fecf474d228e1f/specs/guaranteed-gas-market.md#limiting-guaranteed-gas).
