...
You can get a hosted one from [Alchemy](https://docs.alchemy.com/alchemy/apis/optimism-api), [Infura](https://docs.infura.io/infura#section/Network-Add-Ons/Optimistic-Ethereum), or [QuickNode](https://www.quicknode.com/chains/optimism).
