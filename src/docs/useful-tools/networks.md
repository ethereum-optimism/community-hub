...
- Legacy Geth Data Directory: 
  - [On our server](https://mainnet-migration-data.optimism.io/mainnet-legacy-archival.tar)
  - [On GCS, faster](https://storage.googleapis.com/oplabs-mainnet-data/mainnet-legacy-archival.tar)
