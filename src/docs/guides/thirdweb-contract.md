...
2. Input your preferences for the command line prompts:
   ...
   2. Choose your preferred framework: [Hardhat](https://hardhat.org/) or[Foundry](https://getfoundry.sh/)
...
3. Select [Optimism](https://thirdweb.com/optimism) as the network
...
Optimism contracts are automatically verified upon deployment. To check your status, visit the "Sources" view on your contract's dashboard.

### Need help?

If you have any further questions or encounter any issues during the process, please [reach out to thirdweb support](http://support.thirdweb.com/).
